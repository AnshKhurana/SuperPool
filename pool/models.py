...
class Service(PolymorphicModel):
	...
	category_id=models.ForeignKey(Category,models.DO_NOTHING,related_name="%(class)s_services")
	initiator_id=models.ForeignKey(User,models.DO_NOTHING)
...
class Message(models.Model):
	...
	service_id=models.ForeignKey(Service,models.DO_NOTHING,related_name="messages")
	user_id=models.ForeignKey(User,models.DO_NOTHING,related_name="messages")
